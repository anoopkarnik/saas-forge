...
const CreditsPurchase = ({ onCreateCheckoutSession }: CreditsPurchaseProps) => {
    ...
    const handleCreateCheckout = async () => {
        if (!onCreateCheckoutSession) return;
        setIsPending(true);
        try {
            const { checkoutUrl } = await onCreateCheckoutSession(creditsToBuyAmount);
            if (checkoutUrl) {
