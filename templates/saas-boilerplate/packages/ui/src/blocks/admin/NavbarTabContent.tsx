            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <FormField control={form.control} name="logo" render={({ field }) => (
                        <FormItem><FormLabel>Light Logo</FormLabel><FormControl><ImageUploadField value={field.value ?? ""} onChange={field.onChange} uploadUrl={uploadUrl} /></FormControl><FormMessage /></FormItem>
                    )} />
                    <FormField control={form.control} name="darkLogo" render={({ field }) => (
                        <FormItem><FormLabel>Dark Logo</FormLabel><FormControl><ImageUploadField value={field.value ?? ""} onChange={field.onChange} uploadUrl={uploadUrl} /></FormControl><FormMessage /></FormItem>
                    )} />
                </div>
