...
const TermsOfService = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center relative overflow-x-hidden'>
        ...
        <h2 className="text-title-h2 mt-6 mb-2">Access to the Site</h2>
        <p className="mb-4">
        ...
        <h2 className="text-title-h2 mt-6 mb-2">User Content</h2>
        <p className="mb-4">
        ...
        <h2 className="text-title-h2 mt-6 mb-2">Third-Party Links & Ads; Other Users</h2>
            ...
            <h3 className="text-title-h2 mt-4 mb-2">Disclaimers</h3>
            <p className="mb-4">
            ...
            <h3 className="text-title-h2 mt-4 mb-2">Limitation on Liability</h3>
            <p className="mb-4">
        ...
        <h2 className="text-title-h2 mt-6 mb-2">Copyright Policy</h2>
        <p className="mb-4">
        ...
        <h2 className="text-title-h2 mt-6 mb-2">General</h2>
        <p className="mb-4">
