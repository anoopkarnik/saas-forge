...
export function BalanceCard({ creditsData, isLoading }: BalanceCardProps) {
    const { data: session } = useSession();

    if (isLoading || !session || !session.user || (creditsData?.creditsUsed === undefined && session.user.creditsUsed === undefined) || (creditsData?.creditsTotal === undefined && session.user.creditsTotal === undefined)) {
