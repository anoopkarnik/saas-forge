...
export const MODULE_CONFIG: ModuleSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "NEXT_PUBLIC_EMAIL_CLIENT", description: "Email client for sending emails.", required: true },
      { name: "RESEND_API_KEY", description: "API Key for Resend email service.", showIf: { field: "NEXT_PUBLIC_EMAIL_CLIENT", value: "resend" }, required: true },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "NEXT_PUBLIC_ALLOW_RATE_LIMIT", description: "Rate limiting provider.", required: true },
